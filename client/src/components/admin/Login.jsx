...
import { useNavigate } from 'react-router-dom'; // Optional: for redirection after login
...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await signIn.email({
            ...
            onRequest: () => {
                // Optional: You can set a loading state here
            },
            onSuccess: () => {
                // Better-auth handles the session automatically (usually via cookies).
                // You just need to redirect the user to the dashboard.
